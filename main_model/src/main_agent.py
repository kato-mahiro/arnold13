...
class MainAgent:
    ...
    def get_action_without_modification(self,input_vector):
        output_vector = self.__neurons.get_output(input_vector)
        max_number = output_vector.index(max(output_vector))
        return self.randomized_id[max_number]
    def get_action_with_modification(self, input_vector):
        output_vector = self.__neurons.get_output_and_weights_update(input_vector)
        max_number = output_vector.index(max(output_vector))
        return self.randomized_id[max_number]
